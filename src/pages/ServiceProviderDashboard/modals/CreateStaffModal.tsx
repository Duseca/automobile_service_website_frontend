    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-4xl max-h-[90vh] overflow-auto p-6 relative">
        ...
        <p className="text-sm text-gray-500 mb-6">
          Enter your team member’s details, set their role, and define their
          working hours.
        </p>
      ...
      {showAvailabilityModal && <AvailabilityModal showModal={showAvailabilityModal} onClose={()=>setShowAvailabilityModal(false)} />}
    </div>
  );
};
